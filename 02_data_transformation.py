...
# 3. raw_material_supplier: clean strings, map values, fill missing
if data['raw_material_supplier'].dtype == 'object':
...
# 4. pigment_type: clean strings, enforce allowed values
if data['pigment_type'].dtype == 'object':
...
# 7. mixing_speed: clean strings, enforce categories, fill missing
if data['mixing_speed'].dtype == 'object':
    data['mixing_speed'] = data['mixing_speed'].astype(str).str.strip().str.title()
